 ...
 */
const interpolateNumToRGB = (value: number, min: number, max: number, startRGB: RgbColor, targetRGB: RgbColor): RgbColor => {
...
const mapToChoroplethTresholds = (value: number, thresholds: number[]): string => {
    return 'red';
};

export { mapToChoroplethTresholds };